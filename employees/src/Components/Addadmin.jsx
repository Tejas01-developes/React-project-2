...
const Addadmin = () => {
const[fielddata,setfielddata]=useState({username:"",email:"",password:"",role:["Admin"],departments:["IT"]})
...
const handlesubmit=async()=>{
  ...
  try{
const registerurl=await axios.post("http://localhost:8080/news/addadmin",fielddata,{
